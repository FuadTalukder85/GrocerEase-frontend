...
const VegetableDetailsCard = ({
  vegetableDetails,
}: {
  vegetableDetails: AllProductValues;
}) => {
  ...
  return (
    <div className="flex justify-between items-center gap-5 mt-10 p-28">
      ...
      <div className="w-full border p-7">
        ...
        <p className="mt-5 pb-3">{vegetableDetails.description}</p>
        <hr />
